...
function setRoomURL(roomName) {
    return location.protocol + "//" + location.host + (location.path || "") + "?room=" + roomName;
}
...
function loadSimpleWebRTC() {
  ...
  script.onload = function() {
    ...
    webrtc.on("videoAdded", function(video, peer) {
      ...
      var remotes = document.getElementById("room");
      ...
      if (remotes) {
        ...
        var remoteVideos = document.getElementById("room").getElementsByTagName("video").length;
